...
public:
     ...
     */
    torch::autograd::variable_list forward(std::vector<torch::Tensor> x);
...
protected:
    ...
    torch::nn::ModuleList _cv2;  // box regression layers
    torch::nn::ModuleList _cv3;  // classification layers
...
protected:
    torch::nn::ModuleList _cv4;  // angle prediction layers
};
